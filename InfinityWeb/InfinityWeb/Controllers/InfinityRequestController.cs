...
{
    public class InfinityRequestController : Controller
    {
        private readonly RepositoryContext _context;
        private readonly DataConversions dataConversions;
        public InfinityRequestController(RepositoryContext context)
        {
            _context = context;
        ...
        public async Task<IActionResult> Detail(Guid Id)
        {
            if (Id == Guid.Empty)
            {
                ...
                return RedirectToAction("Index", "InfinityRequest");
            }
            else
            {
                var data = await (from r in _context.Requests
